...
const MyProfile = () => {
  ...
  return (
    <div className='max-w-lg'>
      ...
      {
          isEdit
          ?<input className='bg-zinc-200 text-neutral-800 text-3xl mt-4 font-medium max-w-60' type='text' value={userData.name} onChange={(e) => setUserData(prev=>({...prev,name:e.target.value}))}/>
      ...
      <div>
        ...
        <div className='mt-10'>
          {
            isEdit?
            <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white transition-all duration-500' onClick={()=>setIsEdit(false)}>Save </button>
